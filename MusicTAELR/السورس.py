...
async def ping(client, m: Message):
    ...
    await m_reply.edit(
        f"<b>🏓 السرعه/b> `{delta_ping * 1000:.3f} بالثانيه` \n<b>⏳ شغال</b> - `{uptime}`"
    )
...
async def restart(client, m: Message):
    ...
    await giiim.edit("8")
    await giiim.edit("9")
    await giiim.edit("**تم اعادة تشغيل سورس تايلر ميوزك بنجاح ✓**")
...
• {HNDLR}السرعه - لعرض سرعه النت للبوت

• {HNDLR}الاوامر - لعرض اوامر سورس ميوزك تايلر
